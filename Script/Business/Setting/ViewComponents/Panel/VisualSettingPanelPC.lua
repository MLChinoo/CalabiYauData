local VisualSettingPanelPC = class("VisualSettingPanelPC", PureMVC.ViewComponentPanel)
...
function VisualSettingPanelPC:ListNeededMediators()
  return {}
end
function VisualSettingPanelPC:InitializeLuaEvent()
