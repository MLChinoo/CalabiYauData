local GrowthWeaponDetail = class("GrowthWeaponDetail", PureMVC.ViewComponentPanel)
...
function GrowthWeaponDetail:ListNeededMediators()
  return {GrowthWeaponDetailMediator}
end
function GrowthWeaponDetail:OnInitialized()
  GrowthWeaponDetail.super.OnInitialized(self)
end
function GrowthWeaponDetail:InitializeLuaEvent()
  GrowthWeaponDetail.super.InitializeLuaEvent(self)
end
function GrowthWeaponDetail:Construct()
  GrowthWeaponDetail.super.Construct(self)
end
function GrowthWeaponDetail:Destruct()
  GrowthWeaponDetail.super.Destruct(self)
end
function GrowthWeaponDetail:Update(GrowthDetailData)
...
function GrowthWeaponDetail:UpdateAssistShoot()
  local idx = 1
...
function GrowthWeaponDetail:SetAssistShootItem(Item, key, PropertyName)
  ...
  if info.InBaseNum then
    if info.InBaseNum < info.InNum then
      Item.TextBlock_Num:SetColorAndOpacity(Item.ColorUpgrade)
    elseif info.InBaseNum > info.InNum then
      Item.TextBlock_Num:SetColorAndOpacity(Item.ColorDownUpgrade)
    else
...
function GrowthWeaponDetail:UpdateGunFeature()
