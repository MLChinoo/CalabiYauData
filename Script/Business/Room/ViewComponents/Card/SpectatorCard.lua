...
function SpectatorCard:OnInit()
  self.Img_Background.OnMouseEnterEvent:Bind(self, self.OnShowSwitchBtn)
  self.Img_Background.OnMouseLeaveEvent:Bind(self, self.OnCloseSwitchBtn)
...
function SpectatorCard:OnShowSwitchBtn()
  if self.bShowSwitchButton == false and self.clientPlayerID ~= self.memberInfo.playerId then
    self.Button_Switch:SetVisibility(UE4.ESlateVisibility.Visible)
  end
end
function SpectatorCard:OnCloseSwitchBtn()
  if self.bShowSwitchButton == false then
    self.Button_Switch:SetVisibility(UE4.ESlateVisibility.Collapsed)
  end
end
function SpectatorCard:OnHoverSwitch()
  self.bShowSwitchButton = true
  self.Button_Switch:SetVisibility(UE4.ESlateVisibility.Visible)
end
function SpectatorCard:OnUnhoverSwitch()
  self.bShowSwitchButton = false
  self.Button_Switch:SetVisibility(UE4.ESlateVisibility.Collapsed)
end
